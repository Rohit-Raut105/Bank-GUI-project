...
public class Bank_Gui
{
    ...
    public Bank_Gui(){
        ...
        //bankcard_gui.setBackground(Color.GRAY);
    ...
    public void  credit_card(){
        ...
        display_2.setFont(new Font("Italic",Font.PLAIN,25));

        home_2 = new JButton("Home");
        home_2.setBounds(846,429,120,32);
        panel_2.add(home_2);
        home_2.setBackground(new Color(245, 183, 177));
        home_2.setFont(new Font("Italic",Font.PLAIN,25));
        home_2.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent clicked_goBack_Button){
                    new Bank_Gui();
                    frame_2.dispose();
                }
        ...
        cancle.setFont(new Font("Italic",Font.PLAIN,25));
